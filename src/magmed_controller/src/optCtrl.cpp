...
MagPose optCtrl::controlAllocation(double virtualControlLaw, RowVector4d jacobian, int CTRLMODE)
{
    MagPose magTwist;
...
MagPose optCtrl::generateMagTwist(const double (&refTheta)[2], double thetaL, RowVector4d jacobi)
{
    ...
    MagPose magTwist = controlAllocation(virtualControlLaw, jacobi, 0);
