import os
# os.system("source ~/anaconda3/etc/profile.d/conda.sh && conda activate yolo_d435i")
import random
...
class YoloV5:
    ...
    @torch.no_grad()
    def detect(self, img, canvas=None, view_img=None):
        '''模型预测'''
        # 图像预处理
        ...
        while True:
            ...
            if xyxy_list:
                for i in range(len(xyxy_list)):
                    ...
                    camera_xyz = np.round(np.array(camera_xyz), 5)  # 转成3位小数
