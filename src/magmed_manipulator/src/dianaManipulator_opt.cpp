...
int main(int argc, char *argv[])
{
    ...
    ros::NodeHandle nh;
    // 创建发布对象
    ros::Publisher pub = nh.advertise<std_msgs::Float64MultiArray>("/magmed_manipulator/magnetAngle", 1000);
    ...
    do
    {
        ...
        while (ros::ok())
        {
            ...
            else
            {
                ...
                array_msg.data.push_back(joints[6]); // pub the angle of end_effector
